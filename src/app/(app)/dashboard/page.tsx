    ...
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-5 sm:py-10">
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        ...
        <Link
          ...
          className="press group flex flex-col justify-between gap-4 rounded-3xl bg-ink p-5 text-left sm:p-6"
        >
          <div>
      ...
      <section className="mt-8 grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-border bg-card p-5">
          <p className="font-display text-sm font-bold text-ink">Your journey</p>
